...
export default class App extends React.Component {
    render() {
        return (
            <div>
                <Navbar />
                <div className="container-fluid work-hero text-light text-center">
                    <div className="col-sm-12 col-md-6 work-hero-content-wrapper pt-5 ">
                ...
                <div className="workspace container-fluid pb-5">
                    ...
                    <div className="workspace-content d-flex flex-wrap">
                        ...
                        <div className="workspace-form py-5 mt-4">
                            ...
                            <form className="form px-3 py-3 text-center">
                                ...
                                <input type="text" className="work-input ps-3 my-3" placeholder="Duration" />
